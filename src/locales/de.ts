const de = {
  ...
  "company.features.rightCharacteristics.description":
    "Wir wählen unsere Mitglieder gezielt nach den Eigenschaften aus, die für künftige Führungskräfte entscheidend sind: Verantwortungsbewusstsein, strategisches Denken, Umsetzungswille, Teamfähigkeit und Ambition. Nur wer diese Werte mitbringt, wird Teil von TEG.",
  "company.features.preparation.title":
    "Vorbereitung - Reale Führungskompetenz ab Tag Eins",
  "company.features.preparation.description":
    "Unsere Mitglieder sammeln durch Formate wie Task Forces, Panel Talks, Mentoring, Executive- oder Founders-Associate-Programme echte Erfahrung in unternehmerischer Verantwortung. Wir befähigen sie, sich in komplexen Business-Kontexten sicher zu bewegen und trainieren genau jene Fähigkeiten, die Sie benötigen.",

  "company.features.identification.title":
    "Identifikation – Unsere Mitglieder wollen führen",
  "company.features.identification.description":
    "Unsere Mitglieder brennen dafür, Verantwortung in Konzernen zu übernehmen. Sie denken nicht in Semestern, sondern in Karrieren und sehen in etablierten Unternehmen kein Hindernis, sondern ein Spielfeld für Wachstum, Innovation und Impact. TEG vermittelt nicht nur Skills, sondern auch Haltung.",
  ...
  "student.cardText3.subtitle":
    "Übernimm die Leitung eines Projekts innerhalb von TEG und entwickle Leadership-Skills: Menschen überzeugen, Entscheidungen treffen und Ergebnisse erzielen.",
  "student.cardText3.body":
    "Werde aktiv: Gestalte erfolgreiche Marketingkampagnen, entwerfe Software oder organisiere Panel Talks mit Speakern aus der Wirtschaft und vieles mehr.",
  ...
  "student.howItWorks.mainTitle":
    "So machen wir Dich zu einem solchen Menschen",
  "student.howItWorks.step1.title": "Du wirst Teil von TEG",
  "student.howItWorks.step1.desc1":
    "Im TEG-Office triffst du auf Gleichgesinnte, die mehr wollen und bereit sind, dafür zu liefern.",
  "student.howItWorks.step1.desc2":
    "In einer exklusiven Community mit maximal 50 Mitgliedern unterstützen wir uns gegenseitig mit Skills, Verantwortung und echtem Zusammenhalt.",

  "student.howItWorks.step2.title": "Dein Mehrwert als Mitglied",
  "student.howItWorks.step2.desc1":
    "Alle Programme bei TEG sind darauf ausgelegt, deine Karriere zu beschleunigen egal ob du Gründer:in, Führungskraft oder Unternehmensnachfolger:in werden willst",
  "student.howItWorks.step2.box1":
    "Lerne aus erster Hand, wie man ein Unternehmen führt",
  "student.howItWorks.step2.box2":
    "Positioniere dich strategisch und beschleunige deinen Karriereweg",
  "student.howItWorks.step2.box3":
    "Wachse durch eine starke Community und deren Verbindungen",
  "student.howItWorks.step2.desc2":
    "Unsere Mitglieder übernehmen in echten Projekten unternehmerische Verantwortung, nicht irgendwann, sondern jetzt.",
  ...
  "student.howItWorks.step3.desc2":
    "Unsere Mitglieder führen TEG wie ein Unternehmen und lernen dabei, wie man eines führt.",
  "student.howItWorks.step3.desc3":
    "Dazu kommen exklusive Programme & Formate:",
  "student.howItWorks.step3.sub1.title":
    "Lerne wie Unternehmen funktionieren und erhalte Einblicke, für die andere Jahre brauchen.",
  "student.howItWorks.step3.sub1.box1.title": "Task Forces",
  "student.howItWorks.step3.sub1.box1.desc":
    "Übernimm die Führung eines Projekts innerhalb von TEG und entwickle essenzielle Leadership-Skills. Du lernst dabei, wie man Teams führt, Ressourcen einteilt und Entscheidungen trifft.",
  "student.howItWorks.step3.sub1.box2.title": "Founders-Associate-Programme",
  "student.howItWorks.step3.sub1.box2.desc":
    "Begleite einen unserer Gründer  und erhalte exklusive Einblicke in Strategie, Wachstum und Führung aus erster Hand. Du bist nicht Zuschauer, du bist Teil der Umsetzung",
  "student.howItWorks.step3.sub1.box3.title": "Executive-Associate-Programme",
  "student.howItWorks.step3.sub1.box3.desc":
    "Absolviere ein Praktikum auf C-Level-Niveau bei einem unserer Partnerunternehmen, direkt unter der Geschäftsführung, Bereichsleitung oder einem Vorstand. Du wirst gefordert, gefördert und ernst genommen",

  "student.howItWorks.step3.sub2.title":
    "Beschleunige deine Karriere durch gezielte Positionierung",

  "student.howItWorks.step3.sub2.box1.title": "Panel Talks",
  "student.howItWorks.step3.sub2.box1.desc":
    "Du wirst als Experte eingeladen, bei öffentlichen Veranstaltungen aufzutreten auf Panels, Bühnen und in Workshops. Dabei entwickelst du nicht nur dein Auftreten, sondern positionierst dich auch öffentlich als Thought Leader.",
  "student.howItWorks.step3.sub2.box2.title": "Talent Development",
  "student.howItWorks.step3.sub2.box2.desc":
    "Mit gezieltem Support helfen wir dir, deine eigene Personal Brand zu entwickeln. Dazu gehören unter anderem LinkedIn-Sichtbarkeit, Storytelling, Speaker-Coaching und individuelle Positionierungsstrategien.",

  "student.howItWorks.step3.sub3.title":
    "Profitiere von einer starken Community und deren Verbindungen",
  "student.howItWorks.step3.sub3.box1.title": "Mentoring",
  "student.howItWorks.step3.sub3.box1.desc":
    "Du bekommst einen persönlichen Mentor aus dem TEG-Netzwerk – jemanden, der bereits da ist, wo du hinwillst. Du erhälst Unterstützungbei deinen Herausforderungen, Entscheidungen und Wachstumszielen.",
  "student.howItWorks.step3.sub3.box2.title": "Unternehmensbesuche",
  "student.howItWorks.step3.sub3.box2.desc":
    "Wir organisieren regelmäßige Visits bei Unternehmen, mit denen wir im Austausch stehen. Diese Kontakte helfen dir nicht nur beim Verstehen der Unternehmenswelt sondern öffnen dir die Türen für Berufseinstieg, Projekte und Management Positionen.",

  "student.howItWorks.step4.title": "Was machst du konkret im Verein?",
  "student.howItWorks.step4.desc1":
    "Weil wir TEG wie ein echtes Unternehmen führen, arbeitest du nicht einfach „im Verein mit“ du übernimmst Verantwortung in einem unternehmerischen Setting.",
  "student.howItWorks.step4.desc2":
    "TEG ist strukturiert wie ein Unternehmen: mit klaren Departments, echten Rollen und operativer Umsetzung. Ganz gleich, ob du im Marketing, in der Strategie oder im Event-Team bist, du denkst unternehmerisch und handelst mit Wirkung.",
  "student.howItWorks.step4.desc3":
    "Setze deine Stärken richtig ein, führe eine Task Force, beteilige dich aktiv an unseren Programmen. Du trägst nicht einfach bei, du verantwortest, gestaltest und führst.",
  "student.howItWorks.lastline":
    "Du hast nach einem Semester mehr unternehmerisches Wissen als 99% der Menschen.",
  ...
  "student.applySection.benefits.list.1":
    "Engagierte Community aus High Potentials",
  "student.applySection.benefits.list.2":
    "Zugang zum eigenen Office & Infrastruktur",
  "student.applySection.benefits.list.3":
    "Persönliches Mentoring & Leadership-Coaching",
  "student.applySection.benefits.list.4":
    "Sichtbarkeit durch Events & LinkedIn-Support",
  "student.applySection.benefits.list.5":
    "Lerne, wie Unternehmen wirklich funktionieren",
  "student.applySection.benefits.list.6":
    "Verantwortung ab Tag eins: Projekte, Budgets, Teamführung",
  "student.applySection.requirements.title": "Was Du mitbringen solltest",
  "student.applySection.requirements.list.1":
    "10+ Stunden Commitment pro Woche",
  "student.applySection.requirements.list.2":
    "Bereitschaft, Verantwortung zu übernehmen",
  "student.applySection.requirements.list.3":
    "Wille, in einem Unternehmen unter der Leitung eines CEOs oder Directors zu lernen und zu performen",
  "student.applySection.requirements.list.4":
    "Motivation, auf Executive-Level zu denken & zu handeln",
  "student.applySection.requirements.list.5":
    "Mindset eines Machers, kein Abwarten, sondern Umsetzen",
  ...
  "student.features.meritBased.description":
    "Steige durch eine strukturierte interne Karriereleiter auf, basierend auf nachgewiesener Leistung und Führungsfähigkeit.",
  "student.features.corporateImmersion.title":
    "Eintauchen in die Unternehmenswelt",
  "student.features.corporateImmersion.description":
    "Arbeite direkt mit Führungskräften unserer Partnerunternehmen zusammen und gewinne Einblicke in die Unternehmensführung.",
  "student.features.leadershipDevelopment.title": "Führungsentwicklung",
  "student.features.leadershipDevelopment.description":
    "Entwickle und verfeinere wesentliche Führungsfähigkeiten durch praktische Projekte und Führungsherausforderungen.",

  "student.benefits.title": "Vorteile für Studierende",
  "student.benefits.list.1":
    "Exklusive Gemeinschaft hochqualifizierter Gleichgesinnter (maximal 50).",
  "student.benefits.list.2": "Zugang zu einem eigenen Büro für Zusammenarbeit.",
  "student.benefits.list.3":
    "Beschleunigter Karriereweg durch praktische Erfahrung.",
  "student.benefits.list.4":
    "Direkter Kontakt und Mentoring durch Unternehmensführungskräfte.",
  "student.benefits.list.5":
    "Möglichkeiten, Projekte zu leiten und unternehmerische Fähigkeiten zu entwickeln.",
  "student.benefits.list.6":
    "Bewährte Erfolgsbilanz (39 Jahre) von Alumni-Erfolgen.",
  ...
  "student.requirements.list.2":
    "Aktive Teilnahme an Task Forces und TEG-Aktivitäten.",
  "student.requirements.list.3":
    "Bereitschaft, echte Verantwortung und Rechenschaftspflicht zu übernehmen.",
  "student.requirements.list.4":
    "Ambition für Führungspositionen auf höchstem Niveau.",
  "student.requirements.list.5": "Proaktive Beiträge zum Erfolg der Gruppe.",
  "student.requirements.list.6":
    "Hohe akademische Leistungen und starke Arbeitsmoral.",
