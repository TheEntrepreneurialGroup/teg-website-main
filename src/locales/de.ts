const de = {
  // Home Page Texts
  "home.hero.title":"Gegründet von Deutschlands führenden Unternehmen und visionären Studierenden, zur Förderung der Entscheider von morgen. Seit 1986.",
  "home.hero.subtitle":"Die Entrepreneurial Group (TEG) formt die nächsten Führungspersönlichkeiten der deutschen Wirtschaft. Wir entwickeln außergewöhnliche Talente zu Unternehmern: Gründer, Führungskräfte und Business Leader.",
  ...
  "home.alumni.stat1.label": "Unsere Alumni bilden das Rückgrat der deutschen Wirtschaft ob in Top Management Positionen, im mittleren Management oder in führenden Fachrollen.",
  ...
  "home.legacy.subtitle": "Gegründet von 11 führenden deutschen Unternehmen und vier herausragenden Studierenden. Bewährt über vier Jahrzehnte.",
  "home.legacy.image1.caption": "11 Unternehmen, die TEG mitbegründet haben",
  "home.legacy.image2.caption": "Die 4 Gründungsmitglieder, die TEG Ende 1986 ins Leben riefen.",
  "home.legacy.image3.caption": 'Zeitungsartikel aus dem Donaukurier: "11 Unternehmen gründen neue Studierendeninitiative" erschienen kurz nach der offiziellen Eintragung des TEG-Kuratoriums im Januar 1988.',
  "home.legacy.feature1.title": "Erfolgsbilanz mit Substanz",
  "home.legacy.feature1.description": "Seit 39 Jahren steigen unsere Alumni konsequent in Führungspositionen führender Unternehmen auf oder gründen erfolgreiche Firmen.",
  "home.legacy.feature2.title": " Unternehmerisches Denken mit Corporate-Verantwortung",
  "home.legacy.feature2.description":"Jede Initiative hat ihre Geschichte. Wir bewundern traditionsreiche, exzellent organisierte Unternehmen genauso sehr wie unsere eigene Legacy. Die Visionen früherer TEG-Mitglieder sind heute Realität. Unsere Mitglieder übernehmen Verantwortung, führen Unternehmen mit Weitblick und lösen konkrete Herausforderungen für unsere Partner im Ökosystem. Sie gestalten nicht nur, sie bauen.",
  "home.callToAction1.title": "Partner werden: TEG & Ihr Unternehmen",
  "home.callToAction1.description":"Gestalten Sie mit uns die nächste Generation von Führungskräften. Erfahren Sie, wie Ihr Unternehmen vom Zugang zum TEG-Ökosystem profitieren kann – und erhalten Sie direkten Zugang zu einem seit 39 Jahren bewährten Talent-Pool.",
  ...
  "home.callToAction2.description":"Werde Teil einer selektiven Community von bis zu 50 High-Potentials, die auf Top-Führungsrollen vorbereitet werden – durch echte Verantwortung, Praxiserfahrung und Mentoring. Der Erfolg unserer Alumni über 39 Jahre zeigt, was möglich ist.",
  "home.callToAction2.buttonText": "TEG für Studierende",
  "home.callToAction2.buttonLink": "/for-students",

	"home.partners.title": "Unser Partnerabzeichen",
	"home.partners.description": "1986 gegründet von BMW, BCG und Roland Berger, KPMG, Siemens u.v.m., ist TEG heute eine der renommiertesten Talentschmieden im deutschsprachigen Raum.",

	"home.alumnis.title": "Alumni",
	"home.alumnis.description": "300+ Alumnis, jede:r Dritte Top-Management. Darunter 41 Konzern-Führungskräfte, 40 Mittelstands-Executives und 15 Gründer erfolgreicher Unternehmen.",

  // Company Page Texts
  "company.hero.title":"Wir entwickeln Ihre nächsten Führungstalente. Mit Sicherheit.",
  "company.hero.subtitle":"Werden Sie Partner von TEG und erhalten Sie Zugang zu einem seit 39 Jahren bewährten Talent-Pool außergewöhnlicher Nachwuchsführungskräfte.",
  "company.hero.buttonText": "Partner werden",

  "company.sectionTitle.partnerships.title":"Partner werden, um Zugang zur nächsten Generation an Führungskräften zu erhalten",
  ...
  "company.features.rightCharacteristics.title": "Selektion - Die richtigen Persönlichkeitsmerkmale",
  "company.features.rightCharacteristics.description":"Wir wählen unsere Mitglieder gezielt nach den Eigenschaften aus, die für künftige Führungskräfte entscheidend sind: Verantwortungsbewusstsein, strategisches Denken, Umsetzungswille, Teamfähigkeit und Ambition. Nur wer diese Werte mitbringt, wird Teil von TEG.",
  "company.features.preparation.title": "Vorbereitung - Reale Führungskompetenz ab Tag Eins",
  "company.features.preparation.description": "Unsere Mitglieder sammeln durch Formate wie Task Forces, Panel Talks, Mentoring, Executive- oder Founders-Associate-Programme echte Erfahrung in unternehmerischer Verantwortung. Wir befähigen sie, sich in komplexen Business-Kontexten sicher zu bewegen und trainieren genau jene Fähigkeiten, die Sie benötigen.",
  
  "company.features.identification.title": "Identifikation – Unsere Mitglieder wollen führen",
  "company.features.identification.description": "Unsere Mitglieder brennen dafür, Verantwortung in Konzernen zu übernehmen. Sie denken nicht in Semestern, sondern in Karrieren und sehen in etablierten Unternehmen kein Hindernis, sondern ein Spielfeld für Wachstum, Innovation und Impact. TEG vermittelt nicht nur Skills, sondern auch Haltung.",
  ...
  "company.contact.directorTitle": "Bereichsleiter Organisationsstrategie und Partnerschaften",
