const en = {
  ...
  "company.quality.title": "More than a Degree: A Parallel Career as a Quality Guarantee",
  "company.quality.intro": "TEG members don't just join a club; they undergo a three-semester, intensive management training program alongside their studies. With over 10 hours of investment per week, we simulate real professional life. Working with us means meeting talents who have passed three crucial maturity tests:",
  "company.quality.operational.title": "Operational Excellence",
  "company.quality.operational.desc": "Our members specialize early in functions like Sales, Tech, or Finance and apply this directly in the operational management of TEG.",
  "company.quality.operational.benefit": "Your Benefit: Immediate operational readiness, minimal onboarding.",
  "company.quality.project.title": "Project Management under Pressure",
  "company.quality.project.desc": "Setting goals, managing budgets, meeting deadlines: Our talents learn to steer projects independently and manage setbacks with a solution-oriented mindset.",
  "company.quality.project.benefit": "Your Benefit: Reliable results and structured workflows from day one.",
  "company.quality.leadership.title": "Leadership & Feedback",
  "company.quality.leadership.desc": "The supreme discipline: Members learn early to lead teams and cultivate a professional feedback culture. Our coaches are trained to empower others to perform.",
  "company.quality.leadership.benefit": "Your Benefit: High social competence and leadership potential.",
  "company.quality.resilience": "Proven Resilience: Only those who deliver consistent performance over 3 semesters join our network. This strict selection process is your guarantee of quality.",

  "company.testimonials.title": "What Others Say About Us",
  "company.testimonials.quote1.text": "After coincidentally seeing the team working in their office at 11 PM on a Saturday night, I thought to myself that this initiative is worth supporting.",
  ...
  "company.testimonials.quote2.text": "We need more personal initiative and more entrepreneurship in Germany to move the country forward again. TEG is committed to this. An important contribution from which all participants benefit.",
  ...
  "company.testimonials.quote3.text": "Through my work in Human Resources at BMW, I know what matters in graduates and what qualities are required by innovative companies. TEG trains the skills that are needed but are taught too little at university.",
