        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <TextBoxVorteile
            title={intl.formatMessage({
              id: "company.quality.operational.title",
            })}
            desc={intl.formatMessage({
              id: "company.quality.operational.desc",
            })}
            benefit={intl.formatMessage({
              id: "company.quality.operational.benefit",
            })}
          />
          ...
          <TextBoxVorteile
            ...
            benefit={intl.formatMessage({
              id: "company.quality.project.benefit",
            })}
          />
          ...
          <TextBoxVorteile
            title={intl.formatMessage({
              id: "company.quality.leadership.title",
            })}
            desc={intl.formatMessage({ id: "company.quality.leadership.desc" })}
            benefit={intl.formatMessage({
              id: "company.quality.leadership.benefit",
            })}
          />
        </div>
