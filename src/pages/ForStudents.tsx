    ...
    <div className="bg-white min-h-screen text-slate-900 font-sans overflow-x-hidden">
        ...
        <div className="container-custom px-0 md:px-8 text-left mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-stretch">
            ...
            <div className="md:col-span-6 flex">
              <a href="/events" className="w-full p-8 md:p-10 bg-[#0F2B57] text-white rounded-xl relative overflow-hidden shadow-xl group transition-all hover:bg-[#163a75] flex flex-col justify-between text-left">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
            ...
            <div className="md:col-span-5 order-1 md:order-2">
              <div className="aspect-[4/3] w-full rounded-2xl overflow-hidden shadow-2xl border-4 border-white">
                <img src="/shared/ybla-meeting.jpeg" alt="YBLA" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="container-custom px-4 md:px-8 mx-auto text-left">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-stretch">
            ...
            <motion.div className="md:col-span-7 flex flex-col gap-6" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }}>
              {[
                ...
                <motion.div key={i} className="flex flex-col md:flex-row gap-6 w-full group" variants={itemVariants}>
                  <div className="flex flex-row md:flex-col items-center">
                    ...
                    {i < 2 && <div className="hidden md:block w-0.5 flex-1 bg-slate-100 mt-4" />}
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7">
               ...
               <div className="grid grid-cols-1 gap-3 md:hidden">
                  {[
                    "Unternehmensstrategie", "Forschung & Entwicklung", "Engineering & Software", 
                    "Recht & Compliance", "Sales, Marketing & Operations", "B2B Gründertum"
                  ].map((name, i) => (
                    <div key={i} className="bg-[#051222] border border-white/10 px-4 py-3 rounded-xl text-[12px] font-bold uppercase tracking-widest text-slate-200 text-center">
                      {name}
                    </div>
                  ))}
               </div>
               ...
               <div className="hidden md:flex relative min-h-[550px] items-center justify-center px-10">
                  ...
                  <div className="absolute inset-0 z-10 text-[11px] font-bold uppercase tracking-widest text-slate-200">
                    <div className="absolute top-[10%] left-[10%] bg-[#051222] border border-white/10 px-6 py-3 rounded-full shadow-2xl">Unternehmensstrategie</div>
                    <div className="absolute top-[45%] left-[-2%] bg-[#051222] border border-white/10 px-6 py-3 rounded-full shadow-2xl">Forschung & Entwicklung</div>
                    <div className="absolute bottom-[10%] left-[10%] bg-[#051222] border border-white/10 px-6 py-3 rounded-full shadow-2xl">Engineering & Software</div>
                    <div className="absolute top-[10%] right-[10%] bg-[#051222] border border-white/10 px-6 py-3 rounded-full shadow-2xl">Recht & Compliance</div>
                    <div className="absolute top-[45%] right-[-2%] bg-[#051222] border border-white/10 px-6 py-3 rounded-full shadow-2xl">Sales, Marketing & Operations</div>
                    <div className="absolute bottom-[10%] right-[10%] bg-[#051222] border border-white/10 px-6 py-3 rounded-full shadow-2xl">B2B Gründertum</div>
                  </div>
               </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-white relative overflow-hidden text-left">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none z-0">
          <span className="text-[25vw] font-black uppercase tracking-tighter text-[#B7860B]/5 whitespace-nowrap">YBLA</span>
        </div>
            ...
            <div className="space-y-20">
              ...
              <div className="relative flex flex-col md:flex-row md:justify-center items-start md:items-center pl-12 md:pl-0">
                ...
                <div className="md:w-1/2 md:pr-20 md:text-right mb-4 md:mb-0">
                  ...
                  <p className="text-slate-500 mt-2 max-w-sm md:ml-auto">Du kannst dich jederzeit vorab bewerben. Am 01.10. erhältst du eine Mail zur Bestätigung der Gültigkeit.</p>
                </div>
                <div className="md:w-1/2 md:pl-20">
                  <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 text-[#0F2B57] rounded-full text-[10px] font-black uppercase tracking-widest border border-blue-100"><Mail size={14} className="text-[#B7860B]" /> Jetzt möglich</div>
                </div>
              </div>
              ...
              <div className="relative flex flex-col md:flex-row md:justify-center items-start md:items-center pl-12 md:pl-0">
                ...
                <div className="md:w-1/2 md:pr-20 md:text-right mb-4 md:mb-0">
                  <div className="inline-flex items-center gap-2 px-4 py-2 bg-slate-900 text-white rounded-full text-[10px] font-black uppercase tracking-widest"><Calendar size={14} className="text-[#B7860B]" /> 01. - 24. Oktober</div>
                </div>
                <div className="md:w-1/2 md:pl-20">
              ...
              <div className="relative flex flex-col md:flex-row md:justify-center items-start md:items-center pl-12 md:pl-0">
                ...
                <div className="md:w-1/2 md:pr-20 md:text-right mb-4 md:mb-0">
                  ...
                  <p className="text-slate-500 mt-2 max-w-sm md:ml-auto">Persönliches Kennenlernen der Kandidaten in unserem eigenen TEG Office.</p>
                </div>
                <div className="md:w-1/2 md:pl-20">
                  <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 text-[#0F2B57] rounded-full text-[10px] font-black uppercase tracking-widest border border-blue-100"><Clock size={14} className="text-[#B7860B]" /> 28.10. - 03.11.</div>
                </div>
              </div>

              <div className="relative flex flex-col md:flex-row md:justify-center items-start md:items-center pl-12 md:pl-0">
                <div className="absolute left-0 md:left-1/2 w-10 h-10 rounded-full bg-[#B7860B] md:-translate-x-1/2 z-20 flex items-center justify-center shadow-lg"><Info size={18} className="text-white" /></div>
                <div className="md:w-1/2 md:pr-20 md:text-right mb-4 md:mb-0">
                  <div className="inline-flex items-center gap-2 px-6 py-3 bg-[#B7860B] text-white rounded-full text-xs font-black uppercase tracking-widest shadow-lg">Kick-Off Event</div>
                </div>
                <div className="md:w-1/2 md:pl-20">
      ...
      <section className="py-16 bg-white overflow-hidden text-center mx-auto border-b border-slate-100">
        <h2 className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.3em] mb-12">Unsere Gründer-Firmen</h2>
        <div className="flex whitespace-nowrap mb-8">
          <motion.div initial={{ x: 0 }} animate={{ x: "-50%" }} transition={{ duration: 25, repeat: Infinity, ease: "linear" }} className="flex items-center gap-20 pr-20">
            {[...scrollingLogos, ...scrollingLogos].map((logo, idx) => (
              <img key={idx} src={logo.src} alt={logo.name} className="h-10 w-auto object-contain opacity-60" />
            ))}
          </motion.div>
        </div>
      </section>
      ...
      <section className="pb-24 pt-16 bg-white px-4 text-left">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row overflow-hidden rounded-xl shadow-2xl min-h-[400px]">
          <div className="md:w-1/2 w-full h-72 md:h-auto bg-slate-50 flex items-start">
            <img src="/for-students/team/yassin-portrait.jpeg" alt="Yassin" className="w-full h-full object-cover" />
          </div>
          <div className="md:w-1/2 w-full bg-[#0F2B57] p-10 md:p-14 flex flex-col justify-center text-white">
            ...
            <div className="flex gap-10">
              <a href="https://linkedin.com" className="flex items-center gap-2 text-[#B7860B] hover:text-white text-[10px] font-bold uppercase tracking-widest"><Linkedin size={16} /> LinkedIn</a>
              <a href="mailto:yassin@teg.de" className="flex items-center gap-2 text-[#B7860B] hover:text-white text-[10px] font-bold uppercase tracking-widest"><Mail size={16} /> Email</a>
            </div>
          </div>
        </div>
      </section>
