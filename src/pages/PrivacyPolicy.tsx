      ...
      <section className="py-20">
        <div className="container-custom">
          ...
          <div className="prose prose-lg max-w-none mt-12 text-muted-foreground">
            ...
            <h3>WIX</h3>
            <p>
              Wir hosten unsere Website bei Wix.com Ltd., 40 Namal Tel Aviv St.,
              Tel Aviv 6350671, Israel (nachfolgend: „WIX“).
            </p>
            <p>
              WIX ist ein Tool zum Erstellen und zum Hosten von Webseiten. Wenn
              Sie unsere Website besuchen, werden mit Hilfe von WIX das
              Nutzerverhalten, die Besucherquellen, die Region der
              Websitebesucher und die Besucherzahlen analysiert. WIX speichert
              Cookies auf Ihrem Browser, die für die Darstellung der Website und
              zur Gewährleistung der Sicherheit erforderlich sind (notwendige
              Cookies).
            </p>
            <p>
              Die Daten werden auf den Servern von WIX in Israel gespeichert.
              Israel gilt als datenschutzrechtlich sicherer Drittstaat. Das
              bedeutet, dass Israel ein Datenschutzniveau aufweist, das dem
            ...
            <p>
              Die Verwendung von WIX erfolgt auf Grundlage von Art. 6 Abs. 1
